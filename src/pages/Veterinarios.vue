...
import SubNavBarVeterinario from '../components/Veterinarios/SubNavBarVeterinario.vue';
import MainVeterinario from '../components/Veterinarios/MainVeterinario.vue';
const data = ref(null);
...
<template>
    ...
    <div class="ml-5">
        <SubNavBarVeterinario class="ml-4"></SubNavBarVeterinario>
        <MainVeterinario :userId="userId" :token="token"></MainVeterinario>
    </div>
